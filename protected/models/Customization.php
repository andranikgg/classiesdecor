...
/**
 * This is the model class for table "customization".
 *
 * The followings are the available columns in table 'customization':
 * @property integer $id
 ...
 * @property CustomizationType[] $customizationTypes
 */
class Customization extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name_ru, name_en, desc_ru, desc_en', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'customizationTypes' => array(self::HAS_MANY, 'CustomizationType', 'customization_id'),
		);
	}
