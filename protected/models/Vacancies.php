...
class Vacancies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name_en, name_ru, name_de, name_it', 'length', 'max'=>255),
			array('content_en, content_ru, content_de, content_it', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name_en, name_ru, name_de, name_it, content_en, content_ru, content_de, content_it', 'safe', 'on'=>'search'),
		);
	}
