...
class ExpertsController extends SecureController
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Experts'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Experts');
	 ...
	 * @param Experts $model the model to be validated
	 */
