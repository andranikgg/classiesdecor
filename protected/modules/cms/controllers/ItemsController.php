		...
		if(isset($_POST['Items']))
		{
           ...
           // $model->main = $_POST['Items']['main'];
            ...
            if(  $model->save()) {
                ...
                else if(file_exists($_SERVER['DOCUMENT_ROOT'] .Yii::app()->baseUrl . '/images/up/uploaded.png')) {

                        Yii::app()->ih->load($_SERVER['DOCUMENT_ROOT'] .Yii::app()->baseUrl . '/images/up/uploaded.png')
                            ->save($_SERVER['DOCUMENT_ROOT'] .Yii::app()->baseUrl . '/images/items/' . $model->id . '.png');

                        unlink($_SERVER['DOCUMENT_ROOT'] .Yii::app()->baseUrl . '/images/up/uploaded.png' );
