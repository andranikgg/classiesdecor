...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('address_en')); ?>:</b>
	<?php echo CHtml::encode($data->address_en); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('pin_link')); ?>:</b>
	<?php echo CHtml::encode($data->pin_link); ?>
	<br />
