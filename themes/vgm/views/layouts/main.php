...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/style/vgm.css"/>
    ...
    <script type="text/javascript" src="<?= Yii::app()->request->baseUrl ?>/scripts/vgm.js"></script>
